...
<td>
    <div class="wpsp_number_field">
        <div class="wpsp_number_wrap">
            <input 
                type="number" 
            ...
            <?php if ( isset( $field['unit'] ) && is_array( $field['unit'] ) ) :
                ...
                <?php else :
                    ...
                    $saved_options = isset( $options ) ? $options : get_option( 'wpsp_slider_option', array() );
                    $selected_unit = isset( $saved_options[ $field_Key . '_unit' ] ) 
                        ? $saved_options[ $field_Key . '_unit' ] 
                        : ( $field['unit_selected'] ?? '' );
                    ?>
                    <select 
                        name="wpsp_slider_option[<?php echo esc_attr( $field_Key . '_unit' ); ?>]"
                        class="wpsp_select"
