        ...
        public static function transition_field(){
            ...
            $fields = array(
                ...
                'animation'  => array(
                    ...
                    'default'     => 'slide',
                    'data_hide'   => '.wpbs_coverflow_options, .wpbs_cube_options, .wpbs_cards_options',
                    'data_show'   => array(
        ...
        public static function navigation_field(){
            ...
            $fields = array(
                ...
                'arrow_hover_bg_color' => array(
                    ...
                    'field_type'  => 'wpbscolor',
                    'default'     => '#333333',
                    'extra_class' => 'wpbs_arrow_bg_hover_color',
                ),
        ...
        public static function other_options_field(){
            ...
            $fields = array(
                ...
                'image_unit' => array(
                    ...
                    'default'    => 'px',
                    'desc'       => esc_html__( 'Unit to use for image width and height (e.g, px, %, em). Applied to each slide image.', 'blocksy-slider' ),
                ),
                'width_image' => array(
