...
if ( ! class_exists( 'SLST_Settings_Fields' ) ) :

     /**
	 * Class SLST_Settings_Fields
	 *
	 */
    class SLST_Settings_Fields {
        ...
        public static function transition_field(){
            ...
            $fields = array(
                ...
                'animation'  => array(
                    ...
                    'default'     => 'slide',
                    'data_hide'   => '.slst_coverflow_options, .slst_cube_options, .slst_cards_options, .slst_shadow_push_options, .slst_zoom_split_options, .slst_slide_flow_options, .slst_flip_deck_options, .slst_twist_flow_options, .slst_mirror_options',
                    'data_show'   => array(
                        'cube'       => '.slst_cube_options',
                        'cards'      => '.slst_cards_options',
                        'coverflow'  => '.slst_coverflow_options',
                        'shadow push' => '.slst_shadow_push_options',
                        'zoom split' => '.slst_zoom_split_options',
                        'slide flow' => '.slst_slide_flow_options',
                        'flip deck' => '.slst_flip_deck_options',
                        'twist flow' => '.slst_twist_flow_options',
                        'mirror' => '.slst_mirror_options',
                    ),
                ),
                'cube_shadows' => array(
                    'title'       => esc_html__('Shadows', 'slider-studio'),
                    'field_type'  => 'slstswitch',
                    'default'     => 'yes',
                    'extra_class' => 'slst_cube_options',
                ...
                'cards_border' => array(
                    'title'       => esc_html__('Border Radius (px)', 'slider-studio'),
                    'field_type'  => 'slstnumber',
                    'default'     => 20,
                    'extra_class' => 'slst_cards_options',
                ...
                'coverflow_rotate' => array(
                    ...
                    'field_type'  => 'slstnumber',
                    'default'     => 50,
                    'extra_class' => 'slst_coverflow_options',
                ...
                'creative_shadow_push_prev_shadow' => array(
                    ...
                    'field_type'  => 'slstswitch',
                    'default'     => 'yes',
                    'extra_class' => 'slst_shadow_push_options',
                ...
                'creative_zoom_split_prev_shadow' => array(
                    ...
                    'field_type'  => 'slstswitch',
                    'default'     => 'yes',
                    'extra_class' => 'slst_zoom_split_options',
                ...
                'creative_slide_flow_prev_shadow' => array(
                    ...
                    'field_type'  => 'slstswitch',
                    'default'     => 'yes',
                    'extra_class' => 'slst_slide_flow_options',
                    'desc'        => esc_html__('Enable shadow for previous slide.', 'slider-studio'),
                ),
                ...
                'creative_flip_deck_prev_shadow' => array(
                    ...
                    'field_type'  => 'slstswitch',
                    'default'     => 'yes',
                    'extra_class' => 'slst_flip_deck_options',
                    'desc'        => esc_html__('Enable shadow for previous slide.', 'slider-studio'),
                ),
                ...
                'creative_twist_flow_prev_shadow' => array(
                    ...
                    'field_type'  => 'slstswitch',
                    'default'     => 'yes',
                    'extra_class' => 'slst_twist_flow_options',
                    'desc'        => esc_html__('Enable shadow for previous slide.', 'slider-studio'),
                ),
                ...
                'creative_mirror_prev_shadow' => array(
                    ...
                    'field_type'  => 'slstswitch',
                    'default'     => 'yes',
                    'extra_class' => 'slst_mirror_options',
                    'desc'        => esc_html__('Enable shadow for previous slide.', 'slider-studio'),
                ),
        ...
        public static function navigation_field(){
            ...
            $fields = array(
                ...
                'navigation_arrow_style' => array(
                    ...
                    'default'    => 'style1',
                    'data_hide'  => '.slst_arrow_fields, .slst_arrow_border_radius, .slst_arrow_color, .slst_arrow_bg_color, .slst_arrow_hover_bg_color, .slst_arrow_position',
                    'data_show'  => array(
                        'none'   => '',
                        'style1' => '.slst_arrow_fields',
                        'style2' => '.slst_arrow_fields, .slst_arrow_border_radius, .slst_arrow_color, .slst_arrow_bg_color, .slst_arrow_hover_bg_color',
                        'style3' => '.slst_arrow_fields, .slst_arrow_color, .slst_arrow_bg_color, .slst_arrow_hover_bg_color',
                        'style4' => '.slst_arrow_fields, .slst_arrow_border_radius, .slst_arrow_color, .slst_arrow_bg_color, .slst_arrow_hover_bg_color',
                        'style5' => '.slst_arrow_fields',
                        'custom' => '.slst_arrow_fields, .slst_arrow_border_radius, .slst_arrow_color, .slst_arrow_position',
                    ),
                ),
                'arrow_font_size' => array(
                    'title'       => esc_html__( 'Arrow Font Size (px)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 40,
                    'desc'        => esc_html__( 'Set font size for arrow icon in px.', 'slider-studio' ),
                    'extra_class'   => 'slst_arrow_fields',
                ),
                'arrow_color' => array(
                    'title'       => esc_html__( 'Arrow Color', 'slider-studio' ),
                    'field_type'  => 'slstcolor', 
                    'default'     => '#ffffff',
                    'extra_class' => 'slst_arrow_fields',
                ),
                ...
                'arrow_position_unit' => array(
                    ...
                    'default'     => 'px',
                    'extra_class' => 'slst_arrow_position',
                ),
        ...
        public static function pagination_field(){
            ...
            $fields = array(
                ...
                'pagination_type' => array(
                    ...
                    'data_hide'     => '.slst_bullet_style, .slst_autoplay_progress, .slst_progress_bar, .slst_fraction_style, .slst_custom_style, .slst_bullet_click, .slst_dynamic_bullets, .slst_bullets_bg_color, .slst_bullets_hover_bg_color, .slst_bullets_border_color',
                    'data_show' => array(
                        'bullets'     => '.slst_bullet_style, .slst_bullets_bg_color, .slst_bullets_hover_bg_color, .slst_bullets_border_color, .slst_bullet_click, .slst_dynamic_bullets',
                        'progressbar' => '.slst_autoplay_progress, .slst_progress_bar',
                        'fraction'    => '.slst_fraction_style',
                        'custom'      => '.slst_bullet_click, .slst_dynamic_bullets, .slst_custom_style',
                    ),
                ),
                ...
                'control_progress_bar'  => array(
                    ...
                    'data_show'     => '.slst_progress_bar',
                    'extra_class'   => 'slst_autoplay_progress',
                ),
                ...
                'fraction_navigation_style' => array(
                    ...
                    'default'     => 'style1',
                    'extra_class' => 'slst_fraction_style',
                ),
                ...
                'fraction_font_size' => array(
                    'title'       => esc_html__( 'Fraction Font Size (px)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 20,
                    'extra_class' => 'slst_fraction_style',
                ...
                'custom_navigation_style' => array(
                    ...
                    'default'     => 'style1',
                    'extra_class' => 'slst_custom_style',
                ),
                'bullets_click' => array(
                    'title'       => esc_html__('Bullets Clickable', 'slider-studio'),
                    'field_type'  => 'slstswitch',
                    'default'     => 'yes',
                    'extra_class' => 'slst_bullet_click',
                ...
                'dynamic_bullets' => array(
                    ...
                    'field_type'  => 'slstswitch',
                    'default'     => 'yes',
                    'extra_class' => 'slst_dynamic_bullets',
        ...
        public static function responsive_field(){
            ...
            $fields = array(
                ...
                'slide_control_view_auto' => array(
                    ...
                    'data_show'   => '.slst_auto_slide_width_fields',
                ),
                'auto_slide_width_default' => array(
                    ...
                    'extra_class'   => 'slst_auto_slide_width_fields',
                ),
        ...
        public static function thumbnail_gallery_field(){
            ...
            $fields = array(
                ...
                'thumb_gallery_loop' => array(   
                    ...
                    'extra_class' => 'slst_thumb_gallery',
                ),
                'thumb_gallery_space' => array(
                    'title'       => esc_html__( 'Thumbnail Gallery Space (px)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 10,
                ...
                'thumb_gallery_width' => array(
                    'title'       => esc_html__( 'Thumbnail Width (px)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 80,
                ...
                'thumb_gallery_height' => array(
                    'title'       => esc_html__( 'Thumbnail Height (px)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 80,
                ...
                'thumb_gallery_border_radius' => array(
                    'title'       => esc_html__( 'Thumbnail Border Radius (px)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 0,
        ...
        public static function autoplay_field(){
            ...
            $fields = array(
                ...
                'control_autoplay'  => array(
                    ...
                    'data_show'     => '.slst_autoplay_timing',
                ),
                'autoplay_timing'   => array(
                    'title'         => esc_html__( 'Autoplay time (Second\'s)', 'slider-studio' ),
                    'field_type'    => 'slstnumber',
                    'default'       => 3000,
                    'desc'          => esc_html__( 'Enter autoplay speed in milliseconds (e.g., 3000 for 3 seconds).', 'slider-studio' ),
                    'extra_class'   => 'slst_autoplay_timing',
                ),
                ...
                'control_autoplay_timeleft_color' => array(
                    ...
                    'extra_class' => 'slst_autoplay_time',
                ),
                ...
                'control_autoplay_timeleft_font_size' => array(
                    'title'       => esc_html__( 'Time Font Size (px)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 20,
        ...
        public static function scrollbar_field(){
            ...
            $fields = array(
                ...
                'control_scrollbar' => array(
                    ...
                    'data_show'   => '.slst_scrollbar_wrapper',
                ),
                'scrollbar_position' => array(
                    ...
                    'extra_class' => 'slst_scrollbar_wrapper',
                ),
        ...
        public static function other_options_field(){
            ...
            $fields = array(
                ...
                'border_radius_image' => array(
                    'title'       => esc_html__( 'Border Radius of Image (px)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 0,
                    'unit_disabled' => 'yes',
                ),
                ...
                'control_slide_space' => array(
                    'title'       => esc_html__( 'Slides Space (px)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 10,
                    'unit_disabled' => 'yes',
                ),
                ...
                'control_slide_speed' => array(
                    'title'       => esc_html__( 'Slide Speed (Second\'s)', 'slider-studio' ),
                    'field_type'  => 'slstnumber',
                    'default'     => 400,
