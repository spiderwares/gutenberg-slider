 ...
 * @var array $slst_fields Array of custom CSS settings fields.
 * 
 */
$slst_custom_css_fields = SLST_Settings_Fields::custom_css_field();
...
<div id="custom-class-tab" class="slst-tab-content">
    ...
    slst_get_template( 
        ...
        array(
            'fields'  => $slst_custom_css_fields,     // Merged field definitions.
