...
if( !function_exists( 'wpsp_get_template' ) ) :
    /**
    ...
    function wpsp_get_template( $template_name, $args = array(), $template_path = '' ) {
        if( empty( $template_path ) ) :
            $template_path = WPSP_PATH . 'templates/';
        endif;        
        ...
        do_action( 'wpsp_before_template_part', $template, $args, $template_path );
        ...
        do_action( 'wpsp_after_template_part', $template, $args, $template_path );
    }
