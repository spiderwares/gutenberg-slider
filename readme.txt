...
Slider Studio is a powerful and feature-rich WordPress slider plugin powered by [Swiper.js](https://swiperjs.com/), the most modern mobile touch slider library. This plugin seamlessly integrates with the WordPress Gutenberg block editor, allowing you to create beautiful, responsive sliders with rich content using blocks.

Unlike traditional image-only sliders, Slider Studio lets you build slides using the full power of Gutenberg blocks - add images, text, headings, videos, galleries, and any other block content to create engaging, interactive sliders.
...
[**Demo**](https://plugins.cosmicinfosoftware.com/slider-press/) | [**Documentation**]https://documentation.cosmicinfosoftware.com/slider-press/documents/getting-started/introduction/
...
1. Upload the plugin to the `/wp-content/plugins/slider-studio/` directory or install it via Plugins > Add New.
